...
<title>Récupérer mon mot de passe | UDEMA</title>
...
<body id="login_bg">
	...
	<!-- End Preload -->
	<form action="recuperer" method="POST">
		<div id="login">
			<aside>
				<figure>
				...
				<%
					...
					if (msg != null) {
				%>
				<font face="verdana" color="green"><b><%=msg%></b></font>
				<%
					}
				%>
				<div class="form-group">
					<span class="input"> <input class="input_field" type="email"
						autocomplete="off" name="email"> <label
						class="input_label"> <span class="input__label-content">E-mail</span>
					</label>
					</span>

				</div>
				<input class="btn_1 rounded full-width add_top_30" type="submit"
					value="Récupérer mon mot de passe">
				<div class="text-center add_top_10">
					vous connaissez votre mot de passe ? <strong><a
						href="connexion.html">Se connecter!</a></strong>
				</div>
